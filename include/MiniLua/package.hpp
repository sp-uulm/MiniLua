...
#define MINILUA_CPATH_DEFAULT                                                                      \
    MINILUA_CDIR "?.so;" MINILUA_CDIR "loadall.so;"                                                \
                 "./?.so"

#define MINILUA_PATH_DEFAULT                                                                       \
    MINILUA_LDIR "?.lua;" MINILUA_LDIR "?/init.lua;" MINILUA_CDIR "?.lua;" MINILUA_CDIR            \
                 "?/init.lua;"                                                                     \
                 "./?.lua;"                                                                        \
                 "./?/init.lua"
...
namespace package {
const Value CPATH = Value(
    std::getenv("LUA_CPATH_5_3") != nullptr
        ? std::getenv("LUA_CPATH_5_3")
        : (std::getenv("LUA_CPATH") != nullptr ? std::getenv("LUA_CPATH") : MINILUA_CPATH_DEFAULT));
const Value PATH = Value(
    std::getenv("LUA_PATH_5_3") != nullptr
        ? std::getenv("LUA_PATH_5_3")
