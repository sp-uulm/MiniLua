...
private:
    ...
    auto parse_namelist         (token_it_t& begin, token_it_t& end) const -> parse_result_t<>;
    ...
    auto parse_functioncall     (token_it_t& begin, token_it_t& end) const -> parse_result_t<LuaFunctioncall>;
    auto parse_args             (token_it_t& begin, token_it_t& end) const -> parse_result_t<LuaExplist>;
    auto parse_function         (token_it_t& begin, token_it_t& end) const -> parse_result_t<>;
    auto parse_funcbody         (token_it_t& begin, token_it_t& end) const -> parse_result_t<>;
    auto parse_parlist          (token_it_t& begin, token_it_t& end) const -> parse_result_t<>;
