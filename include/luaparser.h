...
struct lua_tokens : bs::lex::lexer<Lexer>
{
    lua_tokens() {
        ...
        this->self.add
            ...
            ("((\\d+\\.?\\d*)|(\\d*\\.?\\d+))(e-?\\d+)?", LuaToken::Type::NUMLIT)
            ("\\+",                                       LuaToken::Type::ADD)
            ("-",                                         LuaToken::Type::SUB)
            ("\\*",                                       LuaToken::Type::MUL)
            ("\\/",                                       LuaToken::Type::DIV)
            ...
            (":",                                         LuaToken::Type::COLON)
            (",",                                         LuaToken::Type::COMMA)
            ("\\.\\.\\.",                                 LuaToken::Type::ELLIPSE)
            ("\\.\\.",                                    LuaToken::Type::CONCAT)
            ("\\.",                                       LuaToken::Type::DOT)
            ("and\\W", /* \b is not supported :-(*/       LuaToken::Type::AND)
            ("break\\W",                                  LuaToken::Type::BREAK)
            ("do\\W",                                     LuaToken::Type::DO)
            ("elseif\\W",                                 LuaToken::Type::ELSEIF)
            ("else\\W",                                   LuaToken::Type::ELSE)
            ("end",                                       LuaToken::Type::END)
            ("false",                                     LuaToken::Type::FALSE)
            ("for\\W",                                    LuaToken::Type::FOR)
            ("function\\W",                               LuaToken::Type::FUNCTION)
            ("if\\W",                                     LuaToken::Type::IF)
            ("in\\W",                                     LuaToken::Type::IN)
            ("local\\W",                                  LuaToken::Type::LOCAL)
            ("nil",                                       LuaToken::Type::NIL)
            ("not\\W",                                    LuaToken::Type::NOT)
            ("or\\W",                                     LuaToken::Type::OR)
            ("repeat\\W",                                 LuaToken::Type::REPEAT)
            ("return\\W",                                 LuaToken::Type::RETURN)
            ("then\\W",                                   LuaToken::Type::THEN)
            ("true",                                      LuaToken::Type::TRUE)
            ("until\\W",                                  LuaToken::Type::UNTIL)
            ("while\\W",                                  LuaToken::Type::WHILE)
            ("[a-zA-Z_]\\w*",                             LuaToken::Type::NAME)
        ;
    }
};
...
public:
    ...
    token_list_t tokens;
private:
    using token_type = bs::lex::lexertl::token<string::const_iterator, boost::mpl::vector0<>, boost::mpl::false_>;
