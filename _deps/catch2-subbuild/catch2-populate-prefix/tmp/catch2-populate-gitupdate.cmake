...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v2.13.0"
  WORKING_DIRECTORY "/home/tim/Documents/Anwendungsprojekt/Bachelor/MiniLua/_deps/catch2-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/v2.13.0")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v2.13.0")
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/home/tim/Documents/Anwendungsprojekt/Bachelor/MiniLua/_deps/catch2-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/tim/Documents/Anwendungsprojekt/Bachelor/MiniLua/_deps/catch2-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
