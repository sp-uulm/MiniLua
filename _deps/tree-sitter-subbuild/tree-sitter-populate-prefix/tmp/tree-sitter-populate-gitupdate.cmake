...
execute_process(
  COMMAND "/usr/bin/git" show-ref "0.16.9"
  WORKING_DIRECTORY "/home/tim/Documents/Anwendungsprojekt/Bachelor/MiniLua/_deps/tree-sitter-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/0.16.9")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "0.16.9")
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/tree-sitter/tree-sitter.git'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/home/tim/Documents/Anwendungsprojekt/Bachelor/MiniLua/_deps/tree-sitter-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/tim/Documents/Anwendungsprojekt/Bachelor/MiniLua/_deps/tree-sitter-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
